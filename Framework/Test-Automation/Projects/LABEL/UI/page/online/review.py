...
def stream_review():
    ...
    logger.write_debug(u"点击验收，进入验收管理页面")
    common.find_by_xpath(_driver, '//*[@id="main"]/div/div[2]/div/div[2]/div')
    logger.write_debug(u"进入管理批驳（流式）页面")
    ...
    logger.write_debug(u"放弃验收")
    logger.write_debug(u"选择第一条数据，点击继续验收")
    common.find_by_xpath(_driver, '//*[@id="subjob-list"]/table/tbody/tr[1]/td[8]/a[1]')
